...
struct dep_sort {
  ...
  bool add_dependencies(const value_type& node, const C<value_type>& dependencies);
  ...
  bool has_dependency(const value_type& node, const value_type& dependency) const;
